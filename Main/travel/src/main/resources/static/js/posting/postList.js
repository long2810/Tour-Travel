                    ...
                    postBody.insertAdjacentHTML("beforeend", `
                        <div class="col-lg-9 col-sm-12">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="navbar-brand  m-3 fs-5" aria-current="page" href="#">${user.username} post:${postId}</a>
                            </div>
                            <a class="postTitle text-dark fw-bold text-decoration-none fs-4" href="#">${post.title}</a>
